...
(function ($) {
    ...
    $.fn.jshowoff = function (settings) {
        ...
        this.each(function (i) {
            ...
            function transitionTo(gallery, index, src) {
                ...
                if (config.effect == 'slideLeft' && src != 'hover') {
                ...
                } else if (config.effect == 'fade' && src != 'hover') {
                    ...
                    if ($cont.children().length > 1) {
                        $cont.children().css("width", $("#features").width()).eq(0).css('position', 'absolute').fadeOut(config.changeSpeed, function () { $(this).remove(); });
                        $("#features").children().css("width", "100%");
                    };
                } else if (config.effect == 'none' || src == 'hover') {
            ...
            function play(src) {
                if (!isBusy()) {
                    if (src != 'hover') {
                        counter++;
                        transitionTo(gallery, counter, src);
                    }
            ...
            function addControls() {
                $wrap.append('<div class="jshowoff-controls ' + uniqueClass + '-controls"><a class="jshowoff-play ' + uniqueClass + '-play" href="#null">' + config.controlText.pause + '</a><a class="jshowoff-prev ' + uniqueClass + '-prev" href="#null">' + config.controlText.previous + '</a><a class="jshowoff-next ' + uniqueClass + '-next" href="#null">' + config.controlText.next + '</a><div id="slidelinks_holder"></div><div class="clear"></div></div>');
